...
const pincodeDeliveryData = [
  {
    ...
    city: "Bangalore",
    region: "Central",
    standardDelivery: { minDays: 1, maxDays: 2, description: "1-2 days" },
    fastDelivery: { minDays: 0, maxDays: 1, description: "Same Day-1" },
    additionalCost: 500,
    deliveryZones: "metro",
  },
  {
  ...
  },
  {
    ...
    city: "Chennai",
    region: "Central",
    standardDelivery: { minDays: 2, maxDays: 3, description: "2-3 days" },
    fastDelivery: { minDays: 1, maxDays: 2, description: "1-2 days" },
    additionalCost: 800,
    deliveryZones: "metro",
  },
